...
class AppController extends Controller {
	...
	public function beforeFilter() {
		...
		if($this->Auth->User("id")){ //If the user logs in correctly
			...
			$this->Auth->allow('home','confirmation','logincheck','forgotpassword','admin_login','route_url','index','registration','getTitleFromUrl','getTag','add','savePlacements'); //here we have to specify the actions which we want to load without the user authentication.
